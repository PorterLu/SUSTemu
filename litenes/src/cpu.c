...
void cpu_run(long cycles) {
  ...
  while (cycles > 0) {
    ...
    /* Switch dispatch: the compiler sees all call targets statically and
     * can inline addressing-mode + handler pairs.  This replaces the old
     * double-indirect-call through function-pointer tables. */
    switch (op_code) {
    case 0x00: cpu_op_brk();  cycles -= 7; break;
    case 0x01: cpu_address_indirect_x(); cpu_op_ora(); cycles -= 6; break;
    case 0x05: cpu_address_zero_page();  cpu_op_ora(); cycles -= 3; break;
    case 0x06: cpu_address_zero_page();  cpu_op_asl(); cycles -= 5; break;
    case 0x08: cpu_op_php();  cycles -= 3; break;
    case 0x09: cpu_address_immediate();  cpu_op_ora(); cycles -= 2; break;
    case 0x0A: cpu_op_asla(); cycles -= 2; break;
    case 0x0D: cpu_address_absolute();   cpu_op_ora(); cycles -= 4; break;
    case 0x0E: cpu_address_absolute();   cpu_op_asl(); cycles -= 6; break;
    case 0x10: cpu_address_relative();   cpu_op_bpl(); cycles -= 2; break;
    case 0x11: cpu_address_indirect_y(); cpu_op_ora(); cycles -= 5; break;
    case 0x15: cpu_address_zero_page_x(); cpu_op_ora(); cycles -= 4; break;
    case 0x16: cpu_address_zero_page_x(); cpu_op_asl(); cycles -= 6; break;
    case 0x18: cpu_op_clc();  cycles -= 2; break;
    case 0x19: cpu_address_absolute_y(); cpu_op_ora(); cycles -= 4; break;
    case 0x1D: cpu_address_absolute_x(); cpu_op_ora(); cycles -= 4; break;
    case 0x1E: cpu_address_absolute_x(); cpu_op_asl(); cycles -= 7; break;
    case 0x20: cpu_address_absolute();   cpu_op_jsr(); cycles -= 6; break;
    case 0x21: cpu_address_indirect_x(); cpu_op_and(); cycles -= 6; break;
    case 0x24: cpu_address_zero_page();  cpu_op_bit(); cycles -= 3; break;
    case 0x25: cpu_address_zero_page();  cpu_op_and(); cycles -= 3; break;
    case 0x26: cpu_address_zero_page();  cpu_op_rol(); cycles -= 5; break;
    case 0x28: cpu_op_plp();  cycles -= 4; break;
    case 0x29: cpu_address_immediate();  cpu_op_and(); cycles -= 2; break;
    case 0x2A: cpu_op_rola(); cycles -= 2; break;
    case 0x2C: cpu_address_absolute();   cpu_op_bit(); cycles -= 4; break;
    case 0x2D: cpu_address_absolute();   cpu_op_and(); cycles -= 2; break;
    case 0x2E: cpu_address_absolute();   cpu_op_rol(); cycles -= 6; break;
    case 0x30: cpu_address_relative();   cpu_op_bmi(); cycles -= 2; break;
    case 0x31: cpu_address_indirect_y(); cpu_op_and(); cycles -= 5; break;
    case 0x35: cpu_address_zero_page_x(); cpu_op_and(); cycles -= 4; break;
    case 0x36: cpu_address_zero_page_x(); cpu_op_rol(); cycles -= 6; break;
    case 0x38: cpu_op_sec();  cycles -= 2; break;
    case 0x39: cpu_address_absolute_y(); cpu_op_and(); cycles -= 4; break;
    case 0x3D: cpu_address_absolute_x(); cpu_op_and(); cycles -= 4; break;
    case 0x3E: cpu_address_absolute_x(); cpu_op_rol(); cycles -= 7; break;
    case 0x40: cpu_op_rti();  cycles -= 6; break;
    case 0x41: cpu_address_indirect_x(); cpu_op_eor(); cycles -= 6; break;
    case 0x45: cpu_address_zero_page();  cpu_op_eor(); cycles -= 3; break;
    case 0x46: cpu_address_zero_page();  cpu_op_lsr(); cycles -= 5; break;
    case 0x48: cpu_op_pha();  cycles -= 3; break;
    case 0x49: cpu_address_immediate();  cpu_op_eor(); cycles -= 2; break;
    case 0x4A: cpu_op_lsra(); cycles -= 2; break;
    case 0x4C: cpu_address_absolute();   cpu_op_jmp(); cycles -= 3; break;
    case 0x4D: cpu_address_absolute();   cpu_op_eor(); cycles -= 4; break;
    case 0x4E: cpu_address_absolute();   cpu_op_lsr(); cycles -= 6; break;
    case 0x50: cpu_address_relative();   cpu_op_bvc(); cycles -= 2; break;
    case 0x51: cpu_address_indirect_y(); cpu_op_eor(); cycles -= 5; break;
    case 0x55: cpu_address_zero_page_x(); cpu_op_eor(); cycles -= 4; break;
    case 0x56: cpu_address_zero_page_x(); cpu_op_lsr(); cycles -= 6; break;
    case 0x58: cpu_op_cli();  cycles -= 2; break;
    case 0x59: cpu_address_absolute_y(); cpu_op_eor(); cycles -= 4; break;
    case 0x5D: cpu_address_absolute_x(); cpu_op_eor(); cycles -= 4; break;
    case 0x5E: cpu_address_absolute_x(); cpu_op_lsr(); cycles -= 7; break;
    case 0x60: cpu_op_rts();  cycles -= 6; break;
    case 0x61: cpu_address_indirect_x(); cpu_op_adc(); cycles -= 6; break;
    case 0x65: cpu_address_zero_page();  cpu_op_adc(); cycles -= 3; break;
    case 0x66: cpu_address_zero_page();  cpu_op_ror(); cycles -= 5; break;
    case 0x68: cpu_op_pla();  cycles -= 4; break;
    case 0x69: cpu_address_immediate();  cpu_op_adc(); cycles -= 2; break;
    case 0x6A: cpu_op_rora(); cycles -= 2; break;
    case 0x6C: cpu_address_indirect();   cpu_op_jmp(); cycles -= 5; break;
    case 0x6D: cpu_address_absolute();   cpu_op_adc(); cycles -= 4; break;
    case 0x6E: cpu_address_absolute();   cpu_op_ror(); cycles -= 6; break;
    case 0x70: cpu_address_relative();   cpu_op_bvs(); cycles -= 2; break;
    case 0x71: cpu_address_indirect_y(); cpu_op_adc(); cycles -= 5; break;
    case 0x75: cpu_address_zero_page_x(); cpu_op_adc(); cycles -= 4; break;
    case 0x76: cpu_address_zero_page_x(); cpu_op_ror(); cycles -= 6; break;
    case 0x78: cpu_op_sei();  cycles -= 2; break;
    case 0x79: cpu_address_absolute_y(); cpu_op_adc(); cycles -= 4; break;
    case 0x7D: cpu_address_absolute_x(); cpu_op_adc(); cycles -= 4; break;
    case 0x7E: cpu_address_absolute_x(); cpu_op_ror(); cycles -= 7; break;
    case 0x81: cpu_address_indirect_x(); cpu_op_sta(); cycles -= 6; break;
    case 0x84: cpu_address_zero_page();  cpu_op_sty(); cycles -= 3; break;
    case 0x85: cpu_address_zero_page();  cpu_op_sta(); cycles -= 3; break;
    case 0x86: cpu_address_zero_page();  cpu_op_stx(); cycles -= 3; break;
    case 0x88: cpu_op_dey();  cycles -= 2; break;
    case 0x8A: cpu_op_txa();  cycles -= 2; break;
    case 0x8C: cpu_address_absolute();   cpu_op_sty(); cycles -= 4; break;
    case 0x8D: cpu_address_absolute();   cpu_op_sta(); cycles -= 4; break;
    case 0x8E: cpu_address_absolute();   cpu_op_stx(); cycles -= 4; break;
    case 0x90: cpu_address_relative();   cpu_op_bcc(); cycles -= 2; break;
    case 0x91: cpu_address_indirect_y(); cpu_op_sta(); cycles -= 6; break;
    case 0x94: cpu_address_zero_page_x(); cpu_op_sty(); cycles -= 4; break;
    case 0x95: cpu_address_zero_page_x(); cpu_op_sta(); cycles -= 4; break;
    case 0x96: cpu_address_zero_page_y(); cpu_op_stx(); cycles -= 4; break;
    case 0x98: cpu_op_tya();  cycles -= 2; break;
    case 0x99: cpu_address_absolute_y(); cpu_op_sta(); cycles -= 5; break;
    case 0x9A: cpu_op_txs();  cycles -= 2; break;
    case 0x9D: cpu_address_absolute_x(); cpu_op_sta(); cycles -= 5; break;
    case 0xA0: cpu_address_immediate();  cpu_op_ldy(); cycles -= 2; break;
    case 0xA1: cpu_address_indirect_x(); cpu_op_lda(); cycles -= 6; break;
    case 0xA2: cpu_address_immediate();  cpu_op_ldx(); cycles -= 2; break;
    case 0xA4: cpu_address_zero_page();  cpu_op_ldy(); cycles -= 3; break;
    case 0xA5: cpu_address_zero_page();  cpu_op_lda(); cycles -= 3; break;
    case 0xA6: cpu_address_zero_page();  cpu_op_ldx(); cycles -= 3; break;
    case 0xA8: cpu_op_tay();  cycles -= 2; break;
    case 0xA9: cpu_address_immediate();  cpu_op_lda(); cycles -= 2; break;
    case 0xAA: cpu_op_tax();  cycles -= 2; break;
    case 0xAC: cpu_address_absolute();   cpu_op_ldy(); cycles -= 4; break;
    case 0xAD: cpu_address_absolute();   cpu_op_lda(); cycles -= 4; break;
    case 0xAE: cpu_address_absolute();   cpu_op_ldx(); cycles -= 4; break;
    case 0xB0: cpu_address_relative();   cpu_op_bcs(); cycles -= 2; break;
    case 0xB1: cpu_address_indirect_y(); cpu_op_lda(); cycles -= 5; break;
    case 0xB4: cpu_address_zero_page_x(); cpu_op_ldy(); cycles -= 4; break;
    case 0xB5: cpu_address_zero_page_x(); cpu_op_lda(); cycles -= 4; break;
    case 0xB6: cpu_address_zero_page_y(); cpu_op_ldx(); cycles -= 4; break;
    case 0xB8: cpu_op_clv();  cycles -= 2; break;
    case 0xB9: cpu_address_absolute_y(); cpu_op_lda(); cycles -= 4; break;
    case 0xBA: cpu_op_tsx();  cycles -= 2; break;
    case 0xBC: cpu_address_absolute_x(); cpu_op_ldy(); cycles -= 4; break;
    case 0xBD: cpu_address_absolute_x(); cpu_op_lda(); cycles -= 4; break;
    case 0xBE: cpu_address_absolute_y(); cpu_op_ldx(); cycles -= 4; break;
    case 0xC0: cpu_address_immediate();  cpu_op_cpy(); cycles -= 2; break;
    case 0xC1: cpu_address_indirect_x(); cpu_op_cmp(); cycles -= 6; break;
    case 0xC4: cpu_address_zero_page();  cpu_op_cpy(); cycles -= 3; break;
    case 0xC5: cpu_address_zero_page();  cpu_op_cmp(); cycles -= 3; break;
    case 0xC6: cpu_address_zero_page();  cpu_op_dec(); cycles -= 5; break;
    case 0xC8: cpu_op_iny();  cycles -= 2; break;
    case 0xC9: cpu_address_immediate();  cpu_op_cmp(); cycles -= 2; break;
    case 0xCA: cpu_op_dex();  cycles -= 2; break;
    case 0xCC: cpu_address_absolute();   cpu_op_cpy(); cycles -= 4; break;
    case 0xCD: cpu_address_absolute();   cpu_op_cmp(); cycles -= 4; break;
    case 0xCE: cpu_address_absolute();   cpu_op_dec(); cycles -= 6; break;
    case 0xD0: cpu_address_relative();   cpu_op_bne(); cycles -= 2; break;
    case 0xD1: cpu_address_indirect_y(); cpu_op_cmp(); cycles -= 5; break;
    case 0xD5: cpu_address_zero_page_x(); cpu_op_cmp(); cycles -= 4; break;
    case 0xD6: cpu_address_zero_page_x(); cpu_op_dec(); cycles -= 6; break;
    case 0xD8: cpu_op_cld();  cycles -= 2; break;
    case 0xD9: cpu_address_absolute_y(); cpu_op_cmp(); cycles -= 4; break;
    case 0xDD: cpu_address_absolute_x(); cpu_op_cmp(); cycles -= 4; break;
    case 0xDE: cpu_address_absolute_x(); cpu_op_dec(); cycles -= 7; break;
    case 0xE0: cpu_address_immediate();  cpu_op_cpx(); cycles -= 2; break;
    case 0xE1: cpu_address_indirect_x(); cpu_op_sbc(); cycles -= 6; break;
    case 0xE4: cpu_address_zero_page();  cpu_op_cpx(); cycles -= 3; break;
    case 0xE5: cpu_address_zero_page();  cpu_op_sbc(); cycles -= 3; break;
    case 0xE6: cpu_address_zero_page();  cpu_op_inc(); cycles -= 5; break;
    case 0xE8: cpu_op_inx();  cycles -= 2; break;
    case 0xE9: cpu_address_immediate();  cpu_op_sbc(); cycles -= 2; break;
    case 0xEA: cpu_op_nop();  cycles -= 2; break;
    case 0xEC: cpu_address_absolute();   cpu_op_cpx(); cycles -= 4; break;
    case 0xED: cpu_address_absolute();   cpu_op_sbc(); cycles -= 4; break;
    case 0xEE: cpu_address_absolute();   cpu_op_inc(); cycles -= 6; break;
    case 0xF0: cpu_address_relative();   cpu_op_beq(); cycles -= 2; break;
    case 0xF1: cpu_address_indirect_y(); cpu_op_sbc(); cycles -= 5; break;
    case 0xF5: cpu_address_zero_page_x(); cpu_op_sbc(); cycles -= 4; break;
    case 0xF6: cpu_address_zero_page_x(); cpu_op_inc(); cycles -= 6; break;
    case 0xF8: cpu_op_sed();  cycles -= 2; break;
    case 0xF9: cpu_address_absolute_y(); cpu_op_sbc(); cycles -= 4; break;
    case 0xFD: cpu_address_absolute_x(); cpu_op_sbc(); cycles -= 4; break;
    case 0xFE: cpu_address_absolute_x(); cpu_op_inc(); cycles -= 7; break;
    /* Extended opcodes */
    case 0x03: cpu_address_indirect_x(); cpu_op_aso(); cycles -= 8; break;
    case 0x07: cpu_address_zero_page();  cpu_op_aso(); cycles -= 5; break;
    case 0x0F: cpu_address_absolute();   cpu_op_aso(); cycles -= 6; break;
    case 0x13: cpu_address_indirect_y(); cpu_op_aso(); cycles -= 8; break;
    case 0x17: cpu_address_zero_page_x(); cpu_op_aso(); cycles -= 6; break;
    case 0x1B: cpu_address_absolute_y(); cpu_op_aso(); cycles -= 7; break;
    case 0x1F: cpu_address_absolute_x(); cpu_op_aso(); cycles -= 7; break;
    case 0x23: cpu_address_indirect_x(); cpu_op_rla(); cycles -= 8; break;
    case 0x27: cpu_address_zero_page();  cpu_op_rla(); cycles -= 5; break;
    case 0x2F: cpu_address_absolute();   cpu_op_rla(); cycles -= 6; break;
    case 0x33: cpu_address_indirect_y(); cpu_op_rla(); cycles -= 8; break;
    case 0x37: cpu_address_zero_page_x(); cpu_op_rla(); cycles -= 6; break;
    case 0x3B: cpu_address_absolute_y(); cpu_op_rla(); cycles -= 7; break;
    case 0x3F: cpu_address_absolute_x(); cpu_op_rla(); cycles -= 7; break;
    case 0x43: cpu_address_indirect_x(); cpu_op_lse(); cycles -= 8; break;
    case 0x47: cpu_address_zero_page();  cpu_op_lse(); cycles -= 5; break;
    case 0x4F: cpu_address_absolute();   cpu_op_lse(); cycles -= 6; break;
    case 0x53: cpu_address_indirect_y(); cpu_op_lse(); cycles -= 8; break;
    case 0x57: cpu_address_zero_page_x(); cpu_op_lse(); cycles -= 6; break;
    case 0x5B: cpu_address_absolute_y(); cpu_op_lse(); cycles -= 7; break;
    case 0x5F: cpu_address_absolute_x(); cpu_op_lse(); cycles -= 7; break;
    case 0x63: cpu_address_indirect_x(); cpu_op_rra(); cycles -= 8; break;
    case 0x67: cpu_address_zero_page();  cpu_op_rra(); cycles -= 5; break;
    case 0x6F: cpu_address_absolute();   cpu_op_rra(); cycles -= 6; break;
    case 0x73: cpu_address_indirect_y(); cpu_op_rra(); cycles -= 8; break;
    case 0x77: cpu_address_zero_page_x(); cpu_op_rra(); cycles -= 6; break;
    case 0x7B: cpu_address_absolute_y(); cpu_op_rra(); cycles -= 7; break;
    case 0x7F: cpu_address_absolute_x(); cpu_op_rra(); cycles -= 7; break;
    case 0x83: cpu_address_indirect_x(); cpu_op_axs(); cycles -= 6; break;
    case 0x87: cpu_address_zero_page();  cpu_op_axs(); cycles -= 3; break;
    case 0x8F: cpu_address_absolute();   cpu_op_axs(); cycles -= 4; break;
    case 0x93: cpu_address_indirect_y(); cpu_op_axa(); cycles -= 6; break;
    case 0x97: cpu_address_zero_page_y(); cpu_op_axs(); cycles -= 4; break;
    case 0x9F: cpu_address_absolute_y(); cpu_op_axa(); cycles -= 5; break;
    case 0xA3: cpu_address_indirect_x(); cpu_op_lax(); cycles -= 6; break;
    case 0xA7: cpu_address_zero_page();  cpu_op_lax(); cycles -= 3; break;
    case 0xAF: cpu_address_absolute();   cpu_op_lax(); cycles -= 4; break;
    case 0xB3: cpu_address_indirect_y(); cpu_op_lax(); cycles -= 5; break;
    case 0xB7: cpu_address_zero_page_y(); cpu_op_lax(); cycles -= 4; break;
    case 0xBF: cpu_address_absolute_y(); cpu_op_lax(); cycles -= 4; break;
    case 0xC3: cpu_address_indirect_x(); cpu_op_dcm(); cycles -= 8; break;
    case 0xC7: cpu_address_zero_page();  cpu_op_dcm(); cycles -= 5; break;
    case 0xCF: cpu_address_absolute();   cpu_op_dcm(); cycles -= 6; break;
    case 0xD3: cpu_address_indirect_y(); cpu_op_dcm(); cycles -= 8; break;
    case 0xD7: cpu_address_zero_page_x(); cpu_op_dcm(); cycles -= 6; break;
    case 0xDB: cpu_address_absolute_y(); cpu_op_dcm(); cycles -= 7; break;
    case 0xDF: cpu_address_absolute_x(); cpu_op_dcm(); cycles -= 7; break;
    case 0xE3: cpu_address_indirect_x(); cpu_op_ins(); cycles -= 8; break;
    case 0xE7: cpu_address_zero_page();  cpu_op_ins(); cycles -= 5; break;
    case 0xEB: cpu_address_immediate();  cpu_op_sbc(); cycles -= 2; break;
    case 0xEF: cpu_address_absolute();   cpu_op_ins(); cycles -= 6; break;
    case 0xF3: cpu_address_indirect_y(); cpu_op_ins(); cycles -= 8; break;
    case 0xF7: cpu_address_zero_page_x(); cpu_op_ins(); cycles -= 6; break;
    case 0xFB: cpu_address_absolute_y(); cpu_op_ins(); cycles -= 7; break;
    case 0xFF: cpu_address_absolute_x(); cpu_op_ins(); cycles -= 7; break;
    /* Unimplemented / NOP opcodes — still call addr mode (may set op_cycles),
     * but no handler.  Cycle count from table (always 1 for NII). */
    case 0x04: case 0x44: case 0x64:
        cpu_address_zero_page(); cycles -= cpu_op_cycles[op_code]; break;
    case 0x0C: cpu_address_absolute(); cycles -= cpu_op_cycles[op_code]; break;
    case 0x14: case 0x34: case 0x54: case 0x74: case 0xD4: case 0xF4:
        cpu_address_zero_page_x(); cycles -= cpu_op_cycles[op_code]; break;
    case 0x1A: case 0x3A: case 0x5A: case 0x7A: case 0xDA: case 0xFA:
        cycles -= cpu_op_cycles[op_code]; break;
    case 0x1C: case 0x3C: case 0x5C: case 0x7C: case 0xDC: case 0xFC:
        cpu_address_absolute_x(); cycles -= cpu_op_cycles[op_code]; break;
    case 0x80: cpu_address_immediate(); cycles -= cpu_op_cycles[op_code]; break;
    default: cycles -= cpu_op_cycles[op_code]; break;
    }
