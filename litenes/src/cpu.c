...
byte cpu_stack_popb()           { return memory_readb_fast(0x100 + ++cpu.SP);       }
...
/* Switch-based dispatch: compiler converts to jump table (-O2), enabling
 * direct calls that can be inlined — replaces 2 indirect function pointer
 * calls per opcode with 1 switch dispatch + inlineable direct calls. */
static void cpu_dispatch_op(byte op) {
  switch (op) {
    case 0x00: cpu_address_implied(); cpu_op_brk(); return;
    case 0x01: cpu_address_indirect_x(); cpu_op_ora(); return;
    case 0x03: cpu_address_indirect_x(); cpu_op_aso(); return;
    case 0x04: cpu_address_zero_page(); ____FE____(); return;
    case 0x05: cpu_address_zero_page(); cpu_op_ora(); return;
    case 0x06: cpu_address_zero_page(); cpu_op_asl(); return;
    case 0x07: cpu_address_zero_page(); cpu_op_aso(); return;
    case 0x08: cpu_address_implied(); cpu_op_php(); return;
    case 0x09: cpu_address_immediate(); cpu_op_ora(); return;
    case 0x0A: cpu_address_implied(); cpu_op_asla(); return;
    case 0x0C: cpu_address_absolute(); ____FE____(); return;
    case 0x0D: cpu_address_absolute(); cpu_op_ora(); return;
    case 0x0E: cpu_address_absolute(); cpu_op_asl(); return;
    case 0x0F: cpu_address_absolute(); cpu_op_aso(); return;
    case 0x10: cpu_address_relative(); cpu_op_bpl(); return;
    case 0x11: cpu_address_indirect_y(); cpu_op_ora(); return;
    case 0x13: cpu_address_indirect_y(); cpu_op_aso(); return;
    case 0x14: cpu_address_zero_page_x(); ____FE____(); return;
    case 0x15: cpu_address_zero_page_x(); cpu_op_ora(); return;
    case 0x16: cpu_address_zero_page_x(); cpu_op_asl(); return;
    case 0x17: cpu_address_zero_page_x(); cpu_op_aso(); return;
    case 0x18: cpu_address_implied(); cpu_op_clc(); return;
    case 0x19: cpu_address_absolute_y(); cpu_op_ora(); return;
    case 0x1A: cpu_address_implied(); ____FE____(); return;
    case 0x1B: cpu_address_absolute_y(); cpu_op_aso(); return;
    case 0x1C: cpu_address_absolute_x(); ____FE____(); return;
    case 0x1D: cpu_address_absolute_x(); cpu_op_ora(); return;
    case 0x1E: cpu_address_absolute_x(); cpu_op_asl(); return;
    case 0x1F: cpu_address_absolute_x(); cpu_op_aso(); return;
    case 0x20: cpu_address_absolute(); cpu_op_jsr(); return;
    case 0x21: cpu_address_indirect_x(); cpu_op_and(); return;
    case 0x23: cpu_address_indirect_x(); cpu_op_rla(); return;
    case 0x24: cpu_address_zero_page(); cpu_op_bit(); return;
    case 0x25: cpu_address_zero_page(); cpu_op_and(); return;
    case 0x26: cpu_address_zero_page(); cpu_op_rol(); return;
    case 0x27: cpu_address_zero_page(); cpu_op_rla(); return;
    case 0x28: cpu_address_implied(); cpu_op_plp(); return;
    case 0x29: cpu_address_immediate(); cpu_op_and(); return;
    case 0x2A: cpu_address_implied(); cpu_op_rola(); return;
    case 0x2C: cpu_address_absolute(); cpu_op_bit(); return;
    case 0x2D: cpu_address_absolute(); cpu_op_and(); return;
    case 0x2E: cpu_address_absolute(); cpu_op_rol(); return;
    case 0x2F: cpu_address_absolute(); cpu_op_rla(); return;
    case 0x30: cpu_address_relative(); cpu_op_bmi(); return;
    case 0x31: cpu_address_indirect_y(); cpu_op_and(); return;
    case 0x33: cpu_address_indirect_y(); cpu_op_rla(); return;
    case 0x34: cpu_address_zero_page_x(); ____FE____(); return;
    case 0x35: cpu_address_zero_page_x(); cpu_op_and(); return;
    case 0x36: cpu_address_zero_page_x(); cpu_op_rol(); return;
    case 0x37: cpu_address_zero_page_x(); cpu_op_rla(); return;
    case 0x38: cpu_address_implied(); cpu_op_sec(); return;
    case 0x39: cpu_address_absolute_y(); cpu_op_and(); return;
    case 0x3A: cpu_address_implied(); ____FE____(); return;
    case 0x3B: cpu_address_absolute_y(); cpu_op_rla(); return;
    case 0x3C: cpu_address_absolute_x(); ____FE____(); return;
    case 0x3D: cpu_address_absolute_x(); cpu_op_and(); return;
    case 0x3E: cpu_address_absolute_x(); cpu_op_rol(); return;
    case 0x3F: cpu_address_absolute_x(); cpu_op_rla(); return;
    case 0x40: cpu_address_implied(); cpu_op_rti(); return;
    case 0x41: cpu_address_indirect_x(); cpu_op_eor(); return;
    case 0x43: cpu_address_indirect_x(); cpu_op_lse(); return;
    case 0x44: cpu_address_zero_page(); ____FE____(); return;
    case 0x45: cpu_address_zero_page(); cpu_op_eor(); return;
    case 0x46: cpu_address_zero_page(); cpu_op_lsr(); return;
    case 0x47: cpu_address_zero_page(); cpu_op_lse(); return;
    case 0x48: cpu_address_implied(); cpu_op_pha(); return;
    case 0x49: cpu_address_immediate(); cpu_op_eor(); return;
    case 0x4A: cpu_address_implied(); cpu_op_lsra(); return;
    case 0x4C: cpu_address_absolute(); cpu_op_jmp(); return;
    case 0x4D: cpu_address_absolute(); cpu_op_eor(); return;
    case 0x4E: cpu_address_absolute(); cpu_op_lsr(); return;
    case 0x4F: cpu_address_absolute(); cpu_op_lse(); return;
    case 0x50: cpu_address_relative(); cpu_op_bvc(); return;
    case 0x51: cpu_address_indirect_y(); cpu_op_eor(); return;
    case 0x53: cpu_address_indirect_y(); cpu_op_lse(); return;
    case 0x54: cpu_address_zero_page_x(); ____FE____(); return;
    case 0x55: cpu_address_zero_page_x(); cpu_op_eor(); return;
    case 0x56: cpu_address_zero_page_x(); cpu_op_lsr(); return;
    case 0x57: cpu_address_zero_page_x(); cpu_op_lse(); return;
    case 0x58: cpu_address_implied(); cpu_op_cli(); return;
    case 0x59: cpu_address_absolute_y(); cpu_op_eor(); return;
    case 0x5A: cpu_address_implied(); ____FE____(); return;
    case 0x5B: cpu_address_absolute_y(); cpu_op_lse(); return;
    case 0x5C: cpu_address_absolute_x(); ____FE____(); return;
    case 0x5D: cpu_address_absolute_x(); cpu_op_eor(); return;
    case 0x5E: cpu_address_absolute_x(); cpu_op_lsr(); return;
    case 0x5F: cpu_address_absolute_x(); cpu_op_lse(); return;
    case 0x60: cpu_address_implied(); cpu_op_rts(); return;
    case 0x61: cpu_address_indirect_x(); cpu_op_adc(); return;
    case 0x63: cpu_address_indirect_x(); cpu_op_rra(); return;
    case 0x64: cpu_address_zero_page(); ____FE____(); return;
    case 0x65: cpu_address_zero_page(); cpu_op_adc(); return;
    case 0x66: cpu_address_zero_page(); cpu_op_ror(); return;
    case 0x67: cpu_address_zero_page(); cpu_op_rra(); return;
    case 0x68: cpu_address_implied(); cpu_op_pla(); return;
    case 0x69: cpu_address_immediate(); cpu_op_adc(); return;
    case 0x6A: cpu_address_implied(); cpu_op_rora(); return;
    case 0x6C: cpu_address_indirect(); cpu_op_jmp(); return;
    case 0x6D: cpu_address_absolute(); cpu_op_adc(); return;
    case 0x6E: cpu_address_absolute(); cpu_op_ror(); return;
    case 0x6F: cpu_address_absolute(); cpu_op_rra(); return;
    case 0x70: cpu_address_relative(); cpu_op_bvs(); return;
    case 0x71: cpu_address_indirect_y(); cpu_op_adc(); return;
    case 0x73: cpu_address_indirect_y(); cpu_op_rra(); return;
    case 0x74: cpu_address_zero_page_x(); ____FE____(); return;
    case 0x75: cpu_address_zero_page_x(); cpu_op_adc(); return;
    case 0x76: cpu_address_zero_page_x(); cpu_op_ror(); return;
    case 0x77: cpu_address_zero_page_x(); cpu_op_rra(); return;
    case 0x78: cpu_address_implied(); cpu_op_sei(); return;
    case 0x79: cpu_address_absolute_y(); cpu_op_adc(); return;
    case 0x7A: cpu_address_implied(); ____FE____(); return;
    case 0x7B: cpu_address_absolute_y(); cpu_op_rra(); return;
    case 0x7C: cpu_address_absolute_x(); ____FE____(); return;
    case 0x7D: cpu_address_absolute_x(); cpu_op_adc(); return;
    case 0x7E: cpu_address_absolute_x(); cpu_op_ror(); return;
    case 0x7F: cpu_address_absolute_x(); cpu_op_rra(); return;
    case 0x80: cpu_address_immediate(); ____FE____(); return;
    case 0x81: cpu_address_indirect_x(); cpu_op_sta(); return;
    case 0x83: cpu_address_indirect_x(); cpu_op_axs(); return;
    case 0x84: cpu_address_zero_page(); cpu_op_sty(); return;
    case 0x85: cpu_address_zero_page(); cpu_op_sta(); return;
    case 0x86: cpu_address_zero_page(); cpu_op_stx(); return;
    case 0x87: cpu_address_zero_page(); cpu_op_axs(); return;
    case 0x88: cpu_address_implied(); cpu_op_dey(); return;
    case 0x8A: cpu_address_implied(); cpu_op_txa(); return;
    case 0x8C: cpu_address_absolute(); cpu_op_sty(); return;
    case 0x8D: cpu_address_absolute(); cpu_op_sta(); return;
    case 0x8E: cpu_address_absolute(); cpu_op_stx(); return;
    case 0x8F: cpu_address_absolute(); cpu_op_axs(); return;
    case 0x90: cpu_address_relative(); cpu_op_bcc(); return;
    case 0x91: cpu_address_indirect_y(); cpu_op_sta(); return;
    case 0x93: cpu_address_indirect_y(); cpu_op_axa(); return;
    case 0x94: cpu_address_zero_page_x(); cpu_op_sty(); return;
    case 0x95: cpu_address_zero_page_x(); cpu_op_sta(); return;
    case 0x96: cpu_address_zero_page_y(); cpu_op_stx(); return;
    case 0x97: cpu_address_zero_page_y(); cpu_op_axs(); return;
    case 0x98: cpu_address_implied(); cpu_op_tya(); return;
    case 0x99: cpu_address_absolute_y(); cpu_op_sta(); return;
    case 0x9A: cpu_address_implied(); cpu_op_txs(); return;
    case 0x9D: cpu_address_absolute_x(); cpu_op_sta(); return;
    case 0x9F: cpu_address_absolute_y(); cpu_op_axa(); return;
    case 0xA0: cpu_address_immediate(); cpu_op_ldy(); return;
    case 0xA1: cpu_address_indirect_x(); cpu_op_lda(); return;
    case 0xA2: cpu_address_immediate(); cpu_op_ldx(); return;
    case 0xA3: cpu_address_indirect_x(); cpu_op_lax(); return;
    case 0xA4: cpu_address_zero_page(); cpu_op_ldy(); return;
    case 0xA5: cpu_address_zero_page(); cpu_op_lda(); return;
    case 0xA6: cpu_address_zero_page(); cpu_op_ldx(); return;
    case 0xA7: cpu_address_zero_page(); cpu_op_lax(); return;
    case 0xA8: cpu_address_implied(); cpu_op_tay(); return;
    case 0xA9: cpu_address_immediate(); cpu_op_lda(); return;
    case 0xAA: cpu_address_implied(); cpu_op_tax(); return;
    case 0xAC: cpu_address_absolute(); cpu_op_ldy(); return;
    case 0xAD: cpu_address_absolute(); cpu_op_lda(); return;
    case 0xAE: cpu_address_absolute(); cpu_op_ldx(); return;
    case 0xAF: cpu_address_absolute(); cpu_op_lax(); return;
    case 0xB0: cpu_address_relative(); cpu_op_bcs(); return;
    case 0xB1: cpu_address_indirect_y(); cpu_op_lda(); return;
    case 0xB3: cpu_address_indirect_y(); cpu_op_lax(); return;
    case 0xB4: cpu_address_zero_page_x(); cpu_op_ldy(); return;
    case 0xB5: cpu_address_zero_page_x(); cpu_op_lda(); return;
    case 0xB6: cpu_address_zero_page_y(); cpu_op_ldx(); return;
    case 0xB7: cpu_address_zero_page_y(); cpu_op_lax(); return;
    case 0xB8: cpu_address_implied(); cpu_op_clv(); return;
    case 0xB9: cpu_address_absolute_y(); cpu_op_lda(); return;
    case 0xBA: cpu_address_implied(); cpu_op_tsx(); return;
    case 0xBC: cpu_address_absolute_x(); cpu_op_ldy(); return;
    case 0xBD: cpu_address_absolute_x(); cpu_op_lda(); return;
    case 0xBE: cpu_address_absolute_y(); cpu_op_ldx(); return;
    case 0xBF: cpu_address_absolute_y(); cpu_op_lax(); return;
    case 0xC0: cpu_address_immediate(); cpu_op_cpy(); return;
    case 0xC1: cpu_address_indirect_x(); cpu_op_cmp(); return;
    case 0xC3: cpu_address_indirect_x(); cpu_op_dcm(); return;
    case 0xC4: cpu_address_zero_page(); cpu_op_cpy(); return;
    case 0xC5: cpu_address_zero_page(); cpu_op_cmp(); return;
    case 0xC6: cpu_address_zero_page(); cpu_op_dec(); return;
    case 0xC7: cpu_address_zero_page(); cpu_op_dcm(); return;
    case 0xC8: cpu_address_implied(); cpu_op_iny(); return;
    case 0xC9: cpu_address_immediate(); cpu_op_cmp(); return;
    case 0xCA: cpu_address_implied(); cpu_op_dex(); return;
    case 0xCC: cpu_address_absolute(); cpu_op_cpy(); return;
    case 0xCD: cpu_address_absolute(); cpu_op_cmp(); return;
    case 0xCE: cpu_address_absolute(); cpu_op_dec(); return;
    case 0xCF: cpu_address_absolute(); cpu_op_dcm(); return;
    case 0xD0: cpu_address_relative(); cpu_op_bne(); return;
    case 0xD1: cpu_address_indirect_y(); cpu_op_cmp(); return;
    case 0xD3: cpu_address_indirect_y(); cpu_op_dcm(); return;
    case 0xD4: cpu_address_zero_page_x(); ____FE____(); return;
    case 0xD5: cpu_address_zero_page_x(); cpu_op_cmp(); return;
    case 0xD6: cpu_address_zero_page_x(); cpu_op_dec(); return;
    case 0xD7: cpu_address_zero_page_x(); cpu_op_dcm(); return;
    case 0xD8: cpu_address_implied(); cpu_op_cld(); return;
    case 0xD9: cpu_address_absolute_y(); cpu_op_cmp(); return;
    case 0xDA: cpu_address_implied(); ____FE____(); return;
    case 0xDB: cpu_address_absolute_y(); cpu_op_dcm(); return;
    case 0xDC: cpu_address_absolute_x(); ____FE____(); return;
    case 0xDD: cpu_address_absolute_x(); cpu_op_cmp(); return;
    case 0xDE: cpu_address_absolute_x(); cpu_op_dec(); return;
    case 0xDF: cpu_address_absolute_x(); cpu_op_dcm(); return;
    case 0xE0: cpu_address_immediate(); cpu_op_cpx(); return;
    case 0xE1: cpu_address_indirect_x(); cpu_op_sbc(); return;
    case 0xE3: cpu_address_indirect_x(); cpu_op_ins(); return;
    case 0xE4: cpu_address_zero_page(); cpu_op_cpx(); return;
    case 0xE5: cpu_address_zero_page(); cpu_op_sbc(); return;
    case 0xE6: cpu_address_zero_page(); cpu_op_inc(); return;
    case 0xE7: cpu_address_zero_page(); cpu_op_ins(); return;
    case 0xE8: cpu_address_implied(); cpu_op_inx(); return;
    case 0xE9: cpu_address_immediate(); cpu_op_sbc(); return;
    case 0xEA: cpu_address_implied(); cpu_op_nop(); return;
    case 0xEB: cpu_address_immediate(); cpu_op_sbc(); return;
    case 0xEC: cpu_address_absolute(); cpu_op_cpx(); return;
    case 0xED: cpu_address_absolute(); cpu_op_sbc(); return;
    case 0xEE: cpu_address_absolute(); cpu_op_inc(); return;
    case 0xEF: cpu_address_absolute(); cpu_op_ins(); return;
    case 0xF0: cpu_address_relative(); cpu_op_beq(); return;
    case 0xF1: cpu_address_indirect_y(); cpu_op_sbc(); return;
    case 0xF3: cpu_address_indirect_y(); cpu_op_ins(); return;
    case 0xF4: cpu_address_zero_page_x(); ____FE____(); return;
    case 0xF5: cpu_address_zero_page_x(); cpu_op_sbc(); return;
    case 0xF6: cpu_address_zero_page_x(); cpu_op_inc(); return;
    case 0xF7: cpu_address_zero_page_x(); cpu_op_ins(); return;
    case 0xF8: cpu_address_implied(); cpu_op_sed(); return;
    case 0xF9: cpu_address_absolute_y(); cpu_op_sbc(); return;
    case 0xFA: cpu_address_implied(); ____FE____(); return;
    case 0xFB: cpu_address_absolute_y(); cpu_op_ins(); return;
    case 0xFC: cpu_address_absolute_x(); ____FE____(); return;
    case 0xFD: cpu_address_absolute_x(); cpu_op_sbc(); return;
    case 0xFE: cpu_address_absolute_x(); cpu_op_inc(); return;
    case 0xFF: cpu_address_absolute_x(); cpu_op_ins(); return;
    default: break;
  }
}
...
void cpu_run(long cycles) {
  cycles /= 3;
  while (cycles > 0) {
    op_code = memory_readb_fast(cpu.PC++);
    cpu_dispatch_op(op_code);
